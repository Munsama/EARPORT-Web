        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="{{ ('earport fix.png') }}" class="img-responsive" style=" position:center; padding-top: 150px; padding-left: 120px; padding-right: 80px; padding-bottom: 150px; height:100%; width:100%;">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
              ...
              <form class="user" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user " id="Role" placeholder="Sebagai admin" name="role" value="admin" readonly="" >
                </div>
