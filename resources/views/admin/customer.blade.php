...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Tabel Data Akun Customer</h6>
  </div>
  <div class="card-body">
     <div align="right">
      <button type="button" name="create_customer" id="create_customer" class="btn btn-success btn-sm">Tambah Customer</button>
     </div>
     <br />
         ...
         <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-12">
             <input readonly type="text" name="role" id="role" value="customer" class="form-control" />
            </div>
           </div>
...
$(document).ready(function(){
 ...
 $('#create_customer').click(function(){
  $('.modal-title').text("Tambah Akun Customer");
 ...
 $('#sample_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"{{ route('crud_customer.update') }}",
    method:"POST",
    data:new FormData(this),
    contentType: false,
    cache: false,
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   ...
   success:function(html){
    ...
    $('.modal-title').text("Edit Akun Customer");
 ...
 $('#ok_button').click(function(){
  $.ajax({
   url:"crud_customer/destroy/"+user_id,
   beforeSend:function(){
