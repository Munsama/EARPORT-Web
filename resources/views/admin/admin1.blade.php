...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Tabel Data Akun Admin</h6>
  </div>
  <div class="card-body">
     <div align="right">
      <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">Tambah Admin</button>
     </div>
     <br />
...
$(document).ready(function(){
 ...
 $('#create_record').click(function(){
  $('.modal-title').text("Tambah Akun Admin");
 ...
 $(document).on('click', '.edit', function(){
  ...
  $.ajax({
   ...
   success:function(html){
    ...
    $('.modal-title').text("Edit Akun Admin");
 ...
 $('#ok_button').click(function(){
  $.ajax({
   url:"crud_admin/destroy/"+user_id,
   beforeSend:function(){
