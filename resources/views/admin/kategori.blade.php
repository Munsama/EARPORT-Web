...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
     <div align="right">
      <button type="button" name="create_kategori" id="create_kategori" class="btn btn-success btn-sm">Tambah Kategori</button>
     </div>
     <br />
...
$(document).ready(function(){
 ...
 $('#create_kategori').click(function(){
 ...
 $('#sample_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"{{ route('crud_kategori.update') }}",
    method:"POST",
    data:new FormData(this),
    contentType: false,
    cache: false,
 ...
 $('#ok_button').click(function(){
  $.ajax({
   url:"crud_kategori/destroy/"+user_id,
   beforeSend:function(){
